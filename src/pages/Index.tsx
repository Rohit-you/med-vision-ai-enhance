  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden bg-gradient-hero">
        <div 
          ...
          style={{
            backgroundImage: `url('/lovable-uploads/fafa20ff-9bd7-40ab-a580-fe2fab01308b.png')`
          }}
        ></div>
        <div className="relative max-w-7xl px-4 sm:px-6 lg:px-8 py-24 mx-0">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="aspect-video rounded-2xl overflow-hidden shadow-medical">
                <img src="/lovable-uploads/13bc1b0e-6693-4361-826c-96638928a0bb.png" alt="AI Brain Neural Network" className="w-full h-full object-cover opacity-75" />
              </div>
